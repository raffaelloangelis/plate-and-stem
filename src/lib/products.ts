...
export const products: Product[] = [
  ...
  {
    handle: "retinal-night-drops",
    name: "Retinal Night Drops",
    collection: "treat",
    price: 82,
    size: "30 ml",
    shortDescription:
      "0.1% encapsulated retinaldehyde. The fastest retinoid your skin will tolerate.",
    description:
      "Retinaldehyde sits one conversion step from retinoic acid — not three, like a typical retinol. Encapsulated in a liposomal carrier that releases it overnight without the dryness and flaking of free-form retinol. Visible texture and tone change in four weeks. Use four nights a week, not seven.",
    keyActives: [
      { name: "Retinaldehyde (encapsulated)", pct: "0.1%", role: "Cell turnover, photoaging, texture" },
      { name: "Squalane (olive-derived)", pct: "5%", role: "Barrier cushion against retinoid drying" },
      { name: "Bisabolol", pct: "0.5%", role: "Calms retinoid sensitization" },
      { name: "Vitamin E (Tocopherol)", pct: "1%", role: "Stabilizes retinaldehyde from oxidation" },
    ],
    fullIngredients:
      "Caprylic/Capric Triglyceride, Olea Europaea (Olive) Squalane, Retinaldehyde (encapsulated in soy phosphatidylcholine), Bisabolol, Tocopherol, Allantoin, Helianthus Annuus Seed Oil, BHT.",
    origin: "Compounded in Lugano, Switzerland",
    skinTypes: ["Mature", "Sun-damaged", "Texture-prone", "Not for pregnancy or nursing"],
    ritual: "Three drops to clean, dry skin on alternating nights. Build to four nights a week as tolerated. Layer moisturizer over the top. SPF 30+ in the morning is non-negotiable while using this.",
    images: [
      u("1620916566398-39f1143ab7be", 1400),
      u("1631730486572-226d1f595b68", 1400),
      u("1571781926291-c477ebfd024b", 1400),
    ],
  },
  {
